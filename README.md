...
[AmneziaWG 2.0](https://m-1-13-3w5hsuiikq-ez.a.run.app/ru) — продвинутый VPN-протокол на базе WireGuard с обфускацией трафика под обычные протоколы (QUIC, DNS и др.). Устойчив к DPI-блокировкам.
